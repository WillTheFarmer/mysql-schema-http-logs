-- drop procedure -----------------------------------------------------------
DROP PROCEDURE IF EXISTS `parse_access_apache_vhost`;
-- create procedure ---------------------------------------------------------
DELIMITER //
CREATE DEFINER = `root`@`localhost` PROCEDURE `parse_access_apache_vhost`
(
...
BEGIN
  ...
  DECLARE module_name_process VARCHAR(255) DEFAULT 'parse_access_apache_vhost';
